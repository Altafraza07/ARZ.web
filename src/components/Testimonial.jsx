...
const testimonials = [
  {
    name: "Pratik Tiwari",
    quote:
      "Contacted Mr. Altaf Raza in relation to creation of a website related to my legal counsel services. He was quick to respond and got all the details required from me and quickly got to work on it. He was professional and swift throughout the process. I had my site up and running in a matter of days",
    designation: "Advocate at High Court Chhattisgarh",
    location: "Bilaspur | IN",
    img: "/testimonial/pratik.jpg",
    linkedin: "https://www.linkedin.com/in/pratik-tiwari-37856a25a/",
  },
  {
    name: "Sarveshwer Dahre",
    quote:
      "Altaf has been an inspiration since our BCA days. His proficiency in web development and willingness to help others truly stand out. He introduced me to the basics and motivated me with his projects when I was starting my full-stack journey. A talented, kind, and supportive friend!",
  ...
  },
  {
    name: "Adeeb Quraishi",
    quote:
      "Working with Altaf was a great experience. His expertise, reliability, and problem-solving skills always stood out. His work speaks for itself!",
  ...
  // },
  {
    name: "Aryan Sharma",
    quote:
      "Working with Altaf on projects was a great experience. His expertise, creativity, and problem-solving skills stood out, making every project smooth and successful. I have no hesitation in recommending him.",
  ...
  return (
    <>
      <div className="dark:bg-black bg-[#EEEEEE] py-10 md:pb-32">
        ...
        <div
          className={`md:w-[80%] w-full testimonial-carousel-container mx-auto py-12 pb-30 ${
            darkMode
